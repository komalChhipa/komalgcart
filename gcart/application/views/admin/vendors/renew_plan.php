...
?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a data-popup="tooltip"  data-placement="top"  title="<?php _el('email')?>" href="<?php echo site_url('').$vendor['id']; ?> " class=" text-slate" id="<?php echo $vendor['id']; ?>" ><i class="icon-mail5"></i></a>
                        </td>
                    </tr>
<?php
	}
...
function ask_subscriptions()
{
    ...
    if (ids == '')
    {
        ...
        $.ajax({
            url:BASE_URL+'admin/vendors/ask_for_subscription',
            type: 'POST',
            data: {
              ids:ids
            },
